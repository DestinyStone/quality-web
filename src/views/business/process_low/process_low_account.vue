          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div style="display: flex; justify-content: space-around;">
                ...
                <el-link :underline="false"  type="primary" v-if="scope.row.bpmStatus === 2" @click="">通知书上传</el-link>
                <el-link :underline="false"  type="primary" v-if="scope.row.bpmStatus === 2" @click="">标准类上传</el-link>
              </div>
            </template>
          </el-table-column>
        </el-table>
...
<script>
  ...
  export default {
    ...
    components: {ProcessLowDetail, TagSelect},
    data() {
      return {
        showMain: true,
        showDetail: false,
